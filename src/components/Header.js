...
const Header = () => {
  return (
    <header>
      {/* Desktop Menu Starts */}
      <div className="header-inner animated fadeInDown hide-mobile">
        {/* MENU STARTS */}
        <div className="menu">
          <nav>
            <ul>
        ...
        <div className="mail">
          <p>
            Email :<span> <a href={`mailTo:${EMAIL_ADDRESS}`} style={{all:"inherit", cursor:'pointer'}}>{EMAIL_ADDRESS}</a></span>
          </p>
        </div>
        {/* FREELANCE ENDS */}
      </div>
